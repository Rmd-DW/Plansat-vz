...
export default function DashboardVistaFrecuencia() {
  ...
  const [showEvolutionSection, setShowEvolutionSection] = useState(true)
  ...
  return (
    <div className="min-h-screen bg-[#E5E3EE] p-6">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="relative h-[500px] rounded-xl overflow-hidden">
            ...
            <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-gray-100 z-20 max-w-xs">
              <div className="flex items-center justify-between mb-3">
                <h4 className="font-semibold text-gray-800 text-sm">N° Incendios</h4>
        ...
        {/* Evolution and Magnitude Section */}
        <div className="bg-white rounded-2xl p-6 shadow-sm mb-8">
          <div className="flex items-center justify-between mb-6">
            ...
            >
              {showEvolutionSection ? <ChevronUp className="h-5 w-5" /> : <ChevronDown className="h-5 w-5" />}
            </button>
          </div>
              ...
              <div className="bg-gray-50 rounded-xl p-4 relative">
                ...
                <div className="h-32 bg-white rounded-lg flex items-end justify-center p-4">
                  <div className="flex items-end gap-1 h-full">
                    {[0.25, 0.4, 0.6, 0.8, 1, 0.7, 0.5, 0.3].map((height, index) => (
                      <div key={index} className="w-3 bg-red-400 rounded-t" style={{ height: `${height * 100}%` }} />
                    ))}
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 rounded-xl p-4 relative">
                ...
                <div className="h-32 bg-white rounded-lg flex items-end justify-center p-4">
                  <div className="flex items-end gap-2">
                    {[0.8, 1, 0.6, 0.4, 0.3].map((height, index) => (
                      <div key={index} className="w-8 bg-orange-400 rounded-t" style={{ height: `${height * 80}px` }} />
                    ))}
                  </div>
                </div>
              </div>
